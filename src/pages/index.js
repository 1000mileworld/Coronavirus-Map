...
const mapSettings = {
  ...
  zoom: DEFAULT_ZOOM,
  mapEffect: IndexPage.mapEffect3 //reference to function, not calling it
};
...
/**
   ...
   */
async function mapEffect2 ({leafletElement: map}, option=1) {
    
  try {
    response = await axios.get(sources[option]);
  } catch(e) {
...
class IndexPage extends React.Component  {
  ...
  mapEffect3 = async({leafletElement: map}, option=1) => {
